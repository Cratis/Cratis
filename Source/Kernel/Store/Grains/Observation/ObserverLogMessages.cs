...
public static partial class ObserverLogMessages
{
    ...
    [LoggerMessage(11, LogLevel.Debug, "Activating observer {ObserverId} for sequence {EventSequenceId} for microservice '{MicroserviceId}' and tenant '{TenantId}' - observing source microservice '{SourceMicroserviceId}' and tenant '{SourceTenantId}'")]
    ...
    [LoggerMessage(12, LogLevel.Trace, "Subscribing to stream for observer {ObserverId} for sequence {EventSequenceId} for microservice '{MicroserviceId}' and tenant '{TenantId}' - stream {StreamId} - namespace {StreamNamespace}")]
    ...
    [LoggerMessage(13, LogLevel.Trace, "Event of type {EventTypeId} received for observer {ObserverId} from sequence {EventSequenceId} for microservice '{MicroserviceId}' and tenant '{TenantId}'")]
    ...
    [LoggerMessage(14, LogLevel.Debug, "Deactivating observer {ObserverId} for sequence {EventSequenceId} for microservice '{MicroserviceId}' and tenant '{TenantId}' - observing source microservice '{SourceMicroserviceId}' and tenant '{SourceTenantId}'")]
