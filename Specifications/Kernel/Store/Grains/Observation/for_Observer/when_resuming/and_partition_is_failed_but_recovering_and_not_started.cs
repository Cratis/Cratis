...
public class and_partition_is_failed_but_recovering_and_not_started : given.an_observer_and_two_event_types
{
    const string partition = "ca517fc7-6a93-4878-9ccd-8e5b94b264d5";
    void Establish() => state.FailPartition(partition, 0, Array.Empty<string>(), string.Empty);
